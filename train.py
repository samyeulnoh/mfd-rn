...
def make_agent(obs_spec, action_spec, num_expl_steps, cfg):
    ...
    cfg.state_shape = obs_spec["states"].shape
...
class Workspace:
    def __init__(self, cfg):
        ...
        # create data specs
        data_specs = (
            self.train_env.observation_spec()["pixels"],  # name=observation
            self.train_env.observation_spec()["states"],  # name=state
            self.train_env.action_spec(),
